...
/*
 ...
 Determine the average number of foot-candles per hour. Take the hourly foot-candle
 averages for the day, add them, and then divide this sum by 24.
 ...
 Convert foot-candles per hour to PAR (µmol.m-2.s-1) based on light source.
 Do this by multiplying foot-candles per hour by a factor for the light source.
 Sunlight has 0.20 foot-candles per µmol.m-2.s-1.
 HPS lamps have 0.13 foot-candles per µmol.m-2.s-1.

 Using the same example as above, the PAR for crops receiving natural sunlight
 ...
 PAR (µmol. m-2.s-1) x 0.0864

 The 0.0864 factor is the total number of seconds in a day divided by
 1,000,000

 For crops receiving natural sunlight:
 36.8 µmol.m-2.s-1 x 0.0864 = 3.2 mol. m-2.d-1

 For crops receiving HPS lighting:
 23.9 µmol.m-2.s-1 x 0.0864 = 2.1 mol. m-2.d-1
 */
