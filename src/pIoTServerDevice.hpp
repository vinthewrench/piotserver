...
public:
    ...
    {
        dName = _driverName;
        return !_driverName.empty();
    }

    virtual bool getVersion(string&)
    {
        return false;
    }

    virtual bool setValues(keyBoolVector_t)
    {
        return false;
    }

    virtual bool setValues(keyValueMap_t)
    {
        return false;
    }

    virtual bool getValues(keyValueMap_t&)
    {
        return false;
    }
    ...
    virtual void getProperties(json& j)
    {
        ...
        string devID;
        getDeviceID(devID);       // PROP_DEVICE_ID is a psuedo prop
    ...
    virtual device_state_t getDeviceState()
    {
        return _deviceState;
    }
    ...
    virtual void eventNotification(EventTrigger) {}
