...
constexpr string_view NOUN_RULES                   = "rules";
...
// -----------------------------------------------------------------------------
// Common REST / JSON response keys
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// Trigger / schedule JSON keys
// -----------------------------------------------------------------------------

constexpr string_view JSON_ARG_TRIGGER             = "trigger";
constexpr string_view JSON_ARG_SCHEDULE            = "schedule";
constexpr string_view JSON_ARG_CRON                = "cron";
...
// -----------------------------------------------------------------------------
// Device bus / initial value / formula keys
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// Sun / solar time names used by triggers and values
// -----------------------------------------------------------------------------
...
constexpr static string_view PROP_CONFIG_RULE_EVAL_INTERVAL = "rule.eval_interval";



// -----------------------------------------------------------------------------
// Top-level property sections
// -----------------------------------------------------------------------------
...
constexpr static string_view PROP_RULE              = "rule";
...
// -----------------------------------------------------------------------------
// Property file version metadata
// -----------------------------------------------------------------------------
...
constexpr static string_view PROP_ARG_RULE_ID            = "ruleID";
constexpr static string_view PROP_ARG_RULE_IDS           = "ruleIDs";


constexpr static string_view JSON_ARG_CONDITION          = "condition";
constexpr static string_view JSON_ARG_CLEAR_CONDITION    = "clear_condition";

constexpr static string_view JSON_ARG_CLEAR_ACTION       = "clear_action";
